...
// (C) 2019 夏森海 https://github.com/benjinus/android-support-pdfium
// (C) barteksc https://github.com/barteksc/PdfiumAndroid
...
#define JNI_FUNC(retType, bindClass, name) JNIEXPORT retType JNICALL Java_jp_espresso3389_pdfium_##bindClass##_##name
...
extern "C"
{
  ...
  JNI_FUNC(jlong, PdfiumSDK, nativeOpenDocument)
  (JNI_ARGS, jint fd, jstring password)
  {
    ...
    if (!document)
    {
      ...
      {
        jniThrowException(env, "jp/espresso3389/pdfium/PdfPasswordException",
  ...
  JNI_FUNC(jlong, PdfiumSDK, nativeOpenMemDocument)
  (JNI_ARGS, jbyteArray data, jstring password)
  {
    DocumentFile *docFile = new DocumentFile();
  ...
  JNI_FUNC(jint, PdfiumSDK, nativeGetPageCount)
  (JNI_ARGS, jlong documentPtr)
  {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(documentPtr);
    return (jint)FPDF_GetPageCount(doc->pdfDocument);
  }

  JNI_FUNC(void, PdfiumSDK, nativeCloseDocument)
  (JNI_ARGS, jlong documentPtr)
  {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(documentPtr);
    delete doc;
  ...
  JNI_FUNC(jlong, PdfiumSDK, nativeLoadPage)
  (JNI_ARGS, jlong docPtr, jint pageIndex)
  {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
    return loadPageInternal(env, doc, (int)pageIndex);
  }
  JNI_FUNC(jlongArray, PdfiumSDK, nativeLoadPages)
  (JNI_ARGS, jlong docPtr, jint fromIndex,
   jint toIndex)
  {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
  ...
  JNI_FUNC(void, PdfiumSDK, nativeClosePage)
  (JNI_ARGS, jlong pagePtr) { closePageInternal(pagePtr); }
  JNI_FUNC(void, PdfiumSDK, nativeClosePages)
  (JNI_ARGS, jlongArray pagesPtr)
  {
  ...
  JNI_FUNC(jint, PdfiumSDK, nativeGetPageWidthPixel)
  (JNI_ARGS, jlong pagePtr, jint dpi)
  {
    FPDF_PAGE page = reinterpret_cast<FPDF_PAGE>(pagePtr);
    return (jint)(FPDF_GetPageWidth(page) * dpi / 72);
  }
  JNI_FUNC(jint, PdfiumSDK, nativeGetPageHeightPixel)
  (JNI_ARGS, jlong pagePtr, jint dpi)
  {
    FPDF_PAGE page = reinterpret_cast<FPDF_PAGE>(pagePtr);
  ...
  JNI_FUNC(jint, PdfiumSDK, nativeGetPageWidthPoint)
  (JNI_ARGS, jlong pagePtr)
  {
    FPDF_PAGE page = reinterpret_cast<FPDF_PAGE>(pagePtr);
    return (jint)FPDF_GetPageWidth(page);
  }
  JNI_FUNC(jint, PdfiumSDK, nativeGetPageHeightPoint)
  (JNI_ARGS, jlong pagePtr)
  {
    FPDF_PAGE page = reinterpret_cast<FPDF_PAGE>(pagePtr);
    return (jint)FPDF_GetPageHeight(page);
  }
  JNI_FUNC(jobject, PdfiumSDK, nativeGetPageSizeByIndex)
  (JNI_ARGS, jlong docPtr, jint pageIndex,
   jint dpi)
  {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
    ...
    jclass clazz = env->FindClass("jp/espresso3389/pdfium/util/Size");
  ...
  JNI_FUNC(void, PdfiumSDK, nativeRenderPage)
  (JNI_ARGS, jlong pagePtr, jobject objSurface,
  ...
  JNI_FUNC(void, PdfiumSDK, nativeRenderPageBitmap)
  (JNI_ARGS, jlong pagePtr, jobject bitmap,
   jint dpi, jint startX, jint startY,
   jint drawSizeHor, jint drawSizeVer,
   jboolean renderAnnot)
  {
  ...
  JNI_FUNC(jstring, PdfiumSDK, nativeGetDocumentMetaText)
  (JNI_ARGS, jlong docPtr, jstring tag)
  {
  ...
  JNI_FUNC(jobject, PdfiumSDK, nativeGetFirstChildBookmark)
  (JNI_ARGS, jlong docPtr,
   jobject bookmarkPtr)
  {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
  ...
  JNI_FUNC(jobject, PdfiumSDK, nativeGetSiblingBookmark)
  (JNI_ARGS, jlong docPtr, jlong bookmarkPtr)
  {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
  ...
  JNI_FUNC(jstring, PdfiumSDK, nativeGetBookmarkTitle)
  (JNI_ARGS, jlong bookmarkPtr)
  {
  ...
  JNI_FUNC(jlong, PdfiumSDK, nativeGetBookmarkDestIndex)
  (JNI_ARGS, jlong docPtr, jlong bookmarkPtr)
  {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
    FPDF_BOOKMARK bookmark = reinterpret_cast<FPDF_BOOKMARK>(bookmarkPtr);
  ...
  JNI_FUNC(jlongArray, PdfiumSDK, nativeGetPageLinks)
  (JNI_ARGS, jlong pagePtr)
  {
    FPDF_PAGE page = reinterpret_cast<FPDF_PAGE>(pagePtr);
    int pos = 0;
  ...
  JNI_FUNC(jobject, PdfiumSDK, nativeGetDestPageIndex)
  (JNI_ARGS, jlong docPtr, jlong linkPtr)
  {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
  ...
  JNI_FUNC(jstring, PdfiumSDK, nativeGetLinkURI)
  (JNI_ARGS, jlong docPtr, jlong linkPtr)
  {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
    FPDF_LINK link = reinterpret_cast<FPDF_LINK>(linkPtr);
  ...
  JNI_FUNC(jobject, PdfiumSDK, nativeGetLinkRect)
  (JNI_ARGS, jlong linkPtr)
  {
    FPDF_LINK link = reinterpret_cast<FPDF_LINK>(linkPtr);
    FS_RECTF fsRectF;
  ...
  JNI_FUNC(jobject, PdfiumSDK, nativePageCoordinateToDevice)
  (JNI_ARGS, jlong pagePtr, jint startX,
  ...
  JNI_FUNC(jobject, PdfiumSDK, nativeDeviceCoordinateToPage)
  (JNI_ARGS, jlong pagePtr, jint startX,
   jint startY, jint sizeX,
  ...
  JNI_FUNC(jint, PdfiumSDK, nativeGetPageRotation)
  (JNI_ARGS, jlong pagePtr)
  {
    FPDF_PAGE page = reinterpret_cast<FPDF_PAGE>(pagePtr);
  ...
  JNI_FUNC(jlong, PdfiumSDK, nativeLoadTextPage)
  (JNI_ARGS, jlong docPtr, jint pageIndex)
  {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
  ...
  JNI_FUNC(jlongArray, PdfiumSDK, nativeLoadTextPages)
  (JNI_ARGS, jlong docPtr, jint fromIndex,
   jint toIndex)
  {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
  ...
  JNI_FUNC(void, PdfiumSDK, nativeCloseTextPage)
  (JNI_ARGS, jlong textPagePtr)
  {
    closeTextPageInternal(textPagePtr);
  }

  JNI_FUNC(void, PdfiumSDK, nativeCloseTextPages)
  (JNI_ARGS, jlongArray textPagesPtr)
  {
    ...
    for (i = 0; i < length; i++)
    {
      closeTextPageInternal(textPages[i]);
    }
  }

  JNI_FUNC(jint, PdfiumSDK, nativeTextCountChars)
  (JNI_ARGS, jlong textPagePtr)
  {
  ...
  JNI_FUNC(jint, PdfiumSDK, nativeTextGetUnicode)
  (JNI_ARGS, jlong textPagePtr, jint index)
  {
    FPDF_TEXTPAGE textPage = reinterpret_cast<FPDF_TEXTPAGE>(textPagePtr);
    return (jint)FPDFText_GetUnicode(textPage, (int)index);
  }

  JNI_FUNC(jdoubleArray, PdfiumSDK, nativeTextGetCharBox)
  (JNI_ARGS, jlong textPagePtr, jint index)
  {
    FPDF_TEXTPAGE textPage = reinterpret_cast<FPDF_TEXTPAGE>(textPagePtr);
  ...
  JNI_FUNC(jint, PdfiumSDK, nativeTextGetCharIndexAtPos)
  (JNI_ARGS, jlong textPagePtr, jdouble x,
  ...
  JNI_FUNC(jint, PdfiumSDK, nativeTextGetText)
  (JNI_ARGS, jlong textPagePtr, jint start_index,
  ...
  JNI_FUNC(jint, PdfiumSDK, nativeTextCountRects)
  (JNI_ARGS, jlong textPagePtr, jint start_index,
   jint count)
  {
    FPDF_TEXTPAGE textPage = reinterpret_cast<FPDF_TEXTPAGE>(textPagePtr);
  ...
  JNI_FUNC(jdoubleArray, PdfiumSDK, nativeTextGetRect)
  (JNI_ARGS, jlong textPagePtr,
   jint rect_index)
  {
    FPDF_TEXTPAGE textPage = reinterpret_cast<FPDF_TEXTPAGE>(textPagePtr);
  ...
  JNI_FUNC(jint, PdfiumSDK, nativeTextGetBoundedTextLength)
  (JNI_ARGS, jlong textPagePtr,
   jdouble left,
  ...
  JNI_FUNC(jint, PdfiumSDK, nativeTextGetBoundedText)
  (JNI_ARGS, jlong textPagePtr, jdouble left,
  ...
  JNI_FUNC(jlong, PdfiumSDK, nativeSearchStart)
  (JNI_ARGS, jlong textPagePtr, jstring query,
  ...
  JNI_FUNC(void, PdfiumSDK, nativeSearchStop)
  (JNI_ARGS, jlong searchHandlePtr)
  {
    FPDF_SCHHANDLE search = reinterpret_cast<FPDF_SCHHANDLE>(searchHandlePtr);
    FPDFText_FindClose(search);
  }

  JNI_FUNC(jboolean, PdfiumSDK, nativeSearchNext)
  (JNI_ARGS, jlong searchHandlePtr)
  {
    FPDF_SCHHANDLE search = reinterpret_cast<FPDF_SCHHANDLE>(searchHandlePtr);
  ...
  JNI_FUNC(jboolean, PdfiumSDK, nativeSearchPrev)
  (JNI_ARGS, jlong searchHandlePtr)
  {
    FPDF_SCHHANDLE search = reinterpret_cast<FPDF_SCHHANDLE>(searchHandlePtr);
  ...
  JNI_FUNC(jint, PdfiumSDK, nativeGetCharIndexOfSearchResult)
  (JNI_ARGS, jlong searchHandlePtr)
  {
    FPDF_SCHHANDLE search = reinterpret_cast<FPDF_SCHHANDLE>(searchHandlePtr);
  ...
  JNI_FUNC(jint, PdfiumSDK, nativeCountSearchResult)
  (JNI_ARGS, jlong searchHandlePtr)
  {
    FPDF_SCHHANDLE search = reinterpret_cast<FPDF_SCHHANDLE>(searchHandlePtr);
  ...
  //////////////////////////////////////////
  JNI_FUNC(jlong, PdfiumSDK, nativeAddTextAnnotation)
  (JNI_ARGS, jlong docPtr, int page_index,
   jstring text_,
   jintArray color_, jintArray bound_)
  {
    ...
    jclass clazz = env->FindClass("jp/espresso3389/pdfium/PdfiumSDK");
